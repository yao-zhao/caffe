...
TYPED_TEST(LabelSoftmaxLayerTest, TestForward) {
  ...
  EXPECT_EQ(top_data[3], Dtype(0));
  EXPECT_EQ(top_data[4], Dtype(1));
  EXPECT_EQ(top_data[5], Dtype(0));
  EXPECT_EQ(top_data[6], Dtype(0));
  EXPECT_EQ(top_data[7], Dtype(0));
  EXPECT_EQ(top_data[8], Dtype(1));
  EXPECT_EQ(top_data[9], Dtype(1));
  EXPECT_EQ(top_data[10], Dtype(0));
